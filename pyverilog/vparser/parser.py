...
# modified indexed partselect according to verilog-2001
    def p_lpartselect_lpointer_plus(self, p):
        ...
        p[0] = IndexedPartselectUpper(p[1], p[3], p[5], lineno=p.lineno(1))
        p.set_lineno(0, p.lineno(1))

    def p_lpartselect_lpointer_minus(self, p):
        'lpartselect : pointer LBRACKET expression MINUSCOLON expression RBRACKET'
        p[0] = IndexedPartselectLower(p[1], p[3], p[5], lineno=p.lineno(1))
        p.set_lineno(0, p.lineno(1))
